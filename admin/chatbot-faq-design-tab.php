        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="number" id="chat_width_text_desktop" name="chatbot_faq_design_data[chat_width_desktop_num]" value="<?php echo esc_attr($chat_width_desktop); ?>" min="10" max="95" oninput="document.getElementById('chat_width_slider_desktop').value = this.value"> %
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <input type="number" id="chat_width_text_mobile" name="chatbot_faq_design_data[chat_width_mobile_num]" value="<?php echo esc_attr($chat_width_mobile); ?>" min="10" max="95" oninput="document.getElementById('chat_width_slider_mobile').value = this.value"> %
                </td>
            </tr>
        </table>
